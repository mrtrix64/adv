...
$query_Recordset1 = "SELECT cms_content.cms_id,  	cms_content.cms_heading,  	cms_content.cms_content,  	cms_content.cms_image1,  	cms_content.cms_image1_alt,  	cms_content.cms_image2,  	cms_content.cms_image2_alt,  	cms_content.cms_cat,  	cms_content.publish,  	cms_content.sort_order,  	cms_content.advertising,  	cms_content.speaker1_name, 	cms_content.speaker1_desc, 	cms_content.speaker1_img, 	cms_content.speaker2_name, 	cms_content.speaker2_desc, 	cms_content.speaker2_img, 	cms_content.date_time,  	cms_content.time,  	schedule_title.schedule_title_id,  	schedule_title.schedule_date,  	schedule_title.schedule_title,  	schedule_title.friendly_date,  	schedule_title.publish FROM cms_content  	 INNER JOIN schedule_title ON cms_content.date_time = schedule_title.schedule_title_id WHERE cms_content.publish = 'y' AND cms_content.cms_cat = 8 ORDER BY cms_content.sort_order ASC";
