...
$query_Recordset1 = "SELECT cms_content.cms_id,  	cms_content.cms_heading,  	cms_content.date_time,  cms_content.time, 	cms_speakers.spkr_id,  	cms_speakers.spkr_heading, cms_speakers.spkr_image1, cms_speakers.iphone_mugshot,  cms_speakers.spkr_content,	cms_content.cms_content,  	cms_content.sort_order FROM cms_content INNER JOIN cms_speakers ON cms_content.speaker = cms_speakers.spkr_id WHERE cms_content.publish = 'y' AND cms_content.cms_cat = 6 ORDER BY cms_content.sort_order ASC";
