...
$query_Recordset1 = "SELECT * FROM news WHERE publish = 'y' ORDER BY news_date DESC";
...
$query_Recordset1 = "SELECT news_headline, news_article, DATE_FORMAT(`news_date`,'%d/%m/%y') AS showdate FROM news  WHERE publish = 'y' ORDER BY news_date DESC ";
$Recordset1 = mysql_query($query_Recordset1, $abtaFrontConn) or die(mysql_error());
$row_Recordset1 = mysql_fetch_assoc($Recordset1);
