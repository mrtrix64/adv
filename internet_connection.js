    ...
    function checkConnection() {
        ...
        states[Connection.NONE]     = 'No network connection';
		 ...
		 if (states[networkState] == 'No network connection') {
  			alert('Arse! It appears you have no network connection.');
			alert ("Running Static XML");
			var dsSponsors = new Spry.Data.XMLDataSet("xml_static_data/sponsors.xml", "recordset/record", {sortOrderOnLoad: "ascending"}, {useCache: false, loadInterval: 5000});
			...
			var dsSchedule = new Spry.Data.XMLDataSet("xml_static_data/schedule.xml", "recordset/record", {sortOnLoad: "sort_order", sortOrderOnLoad: "ascending"}, {useCache: false, loadInterval: 5000});
			dsSchedule.setColumnType("title_date", "number");
			dsSchedule.setColumnType("title", "html");
			dsSchedule.setColumnType("sort_order", "number");
			var dsLeisure = new Spry.Data.XMLDataSet("xml_static_data/leisure.xml", "recordset/record", {useCache: false, loadInterval: 5000});
			...
			var dsPlenary = new Spry.Data.XMLDataSet("xml_static_data/plenary.xml", "recordset/record", {useCache: false, loadInterval: 5000});
			...
			var dsBreakout = new Spry.Data.XMLDataSet("xml_static_data/breakout.xml", "recordset/record", {useCache: false, loadInterval: 5000});
			...
			var dsNews = new Spry.Data.XMLDataSet("xml_static_data/news.xml", "recordset/record", {useCache: false, loadInterval: 5000});
			dsNews.setColumnType("news_article", "html");
			var dsSocial = new Spry.Data.XMLDataSet("xml_static_data/social.xml", "recordset/record", {useCache: false, loadInterval: 5000});
			dsSocial.setColumnType("cms_content", "html");
			dsSocial.setColumnType("sort_order", "number");
			dsSocial.setColumnType("date_time", "number");
			var delegates = new Spry.Data.XMLDataSet("xml_static_data/delegates.xml", "recordset/record", {useCache: false, loadInterval: 5000});
