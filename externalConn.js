// JavaScript Document
var dsSponsors = new Spry.Data.XMLDataSet("http://advantagetravel.e-update.co.uk/mobile/data/sponsors.php?view_xml=1?view_xml=1", "recordset/record", {sortOrderOnLoad: "ascending"});
...
dsSchedule.setColumnType("sort_order", "number");
	var dsHotels = new Spry.Data.XMLDataSet("http://advantagetravel.e-update.co.uk/mobile/data/hotels.php?view_xml=1", "recordset/record", {sortOnLoad: "hotel_name", sortOrderOnLoad: "ascending"});
...
var dsSpecialist = new Spry.Data.XMLDataSet("http://advantagetravel.e-update.co.uk/mobile/data/specialist.php?view_xml=1", "recordset/record");
...
var dsForum = new Spry.Data.XMLDataSet("http://advantagetravel.e-update.co.uk/mobile/data/marketing.php?view_xml=1", "recordset/record");
...
var dsDates = new Spry.Data.XMLDataSet("http://advantagetravel.e-update.co.uk/mobile/data/dates.php?view_xml=1", "recordset/record", {sortOnLoad: "schedule_title_id", sortOrderOnLoad: "ascending"});
